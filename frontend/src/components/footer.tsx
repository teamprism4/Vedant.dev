      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
            <span className="font-mono gradient-text font-semibold">Vedant Garje</span>
            <span>·</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://leetcode.com/vedant43"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mt-4 text-center text-xs text-muted-foreground/50">
          © {new Date().getFullYear()} Vedant Garje · Open to opportunities
        </div>
      </div>
    </footer>
  );
