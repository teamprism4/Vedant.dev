...
export function ExperienceSection() {
  ...
  const experiences = [
    ...
    {
      company: "WeCodeCrunchers",
      role: "Software Development Intern",
      duration: "2025 — Present", 
      location: "India",
      type: "Internship",
      url: "https://www.linkedin.com/in/vedant-garje-291956356",
      description:
        "Contributing to software development projects while strengthening frontend development, Java programming, and collaborative problem-solving through practical project work.",
  
      achievements: [
        "Developed responsive web interfaces using modern frontend technologies",
        "Built Java-based desktop applications following object-oriented programming principles",
        "Collaborated on real-world software projects and gained experience with the software development lifecycle",
        "Improved debugging, code organization, and version control practices during development"
      ],
  
      tech: [ "HTML","CSS", "JavaScript", "React", "Next.js", "Tailwind CSS", "Git", "GitHub"  ],
  ...
  return (
    <section id="experience" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6" ref={ref}>
        ...
        >
          <a
            href="www.linkedin.com/in/vedant-garje-291956356"
            target="_blank"
            rel="noopener noreferrer"
