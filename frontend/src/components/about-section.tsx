          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-foreground/90 leading-relaxed text-[15px]">
                I&apos;m <strong className="text-foreground">Vedant Garje</strong>, a
              ...
              <p className="text-muted-foreground leading-relaxed text-[15px]">
                ...
                hood. That curiosity turned into {ghRepos}+ shipped projects, 
                {/* {lcTotal} */}
            ...
            >
              ...
              {[
                ...
                { label: "GitHub", value: `@vedant · $ 20+ repos` },
              //  { label: "LeetCode", value: `@vedant · Rank #${lcRank.toLocaleString("en-US")}` },
              ].map((fact) => (
